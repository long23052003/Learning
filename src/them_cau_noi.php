                    ...
                    if (isset($_GET['id_khoa_hoc'])) {
                        if ($_POST['num_choices'] < 2 || $_POST['num_choices'] > 10) {
                            ...
                            if (!$answersFilled) {
                                ...
                                $questionsAndAnswers = [];
                                for ($i = 0; $i < $num_choices; $i++) {
                                    $cau_hoi = isset($_POST['cauhoi'][$i]) ? trim($_POST['cauhoi'][$i]) : '';
                                    $dap_an = isset($_POST['da'][$i]) ? trim($_POST['da'][$i]) : '';
                                ...
                                $ten_cau_hoi = isset($_POST['cauhoi']) ? implode(';', array_map('trim', $_POST['cauhoi'])) : '';
                                ...
                                if ($query) {
                                    echo "<div class='alert-success' role='alert'>Thêm câu hỏi thành công.";
                                } else {
