            ...
            if (isset($_POST['btn'])) {
                if (isset($_GET['id_khoa_hoc'])) {
                    if (empty($_POST['ten_cau_hoi'])) {
                        ...
                        $sql = "INSERT INTO `cau_hoi`(`ten_cau_hoi`, `dang_cau_hoi`, `dap_an`, `file_tai_len`,`id_khoa_hoc`,`trang_thai`,`id_user`) VALUES ('$ten_cau_hoi','$dang_cau_hoi','$da','$file_tai_len','$id_khoa_hoc',0,'$id_user')";
